...
export const SCHEDULES: Schedule[] = [
  ...
  { day: 'Selasa', session: 'morning', subject: 'Riyadhus Sholihin', teacher: 'aba Yahya', pj: 'Yusrin', time: '05.00' },
  ...
  { day: 'Selasa', session: 'evening', subject: "Fathul Mu'in", teacher: 'aba Yahya', pj: 'Silvia', time: '20.00' },
